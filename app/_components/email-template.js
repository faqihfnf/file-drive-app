    ...
    <Html>
      ...
      <Body style={main}>
        <Container>
          <Section style={content}>
            ...
            <Row style={{ paddingBottom: "0" }}>
              <Column>
                ...
                <Text style={paragraph}>Now You can also share file with Tubegurji FileSharo App</Text>
                <Text style={{ marginTop: -5 }}>Click Below Button to Access your file</Text>
              </Column>
            </Row>
          ...
          >
            © 2024 | Tubegurji @2024 Copyrights U.S.A. | www.Tubeguruji.com
          </Text>
        </Container>
      </Body>
    </Html>
